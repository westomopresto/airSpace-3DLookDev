...
var airSpaceTEX = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/westomopresto/airSpace-3DLookDev/master/lib/textures/bt_color__airSpace_m_Base.png" );
var bldTEX = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/westomopresto/airSpace-3DLookDev/master/lib/textures/bt_color__bld_m_Base.png" );
var lotTEX = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/westomopresto/airSpace-3DLookDev/master/lib/textures/bt_color__lot_m_Base.png" );
var mountainTEX = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/westomopresto/airSpace-3DLookDev/master/lib/textures/bt_color__mountain_ocean_m_Base.png" );
var restTEX = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/westomopresto/airSpace-3DLookDev/master/lib/textures/bt_color__rest_m_Base.png" );

const canvas = document.querySelector('#canvas');

// the 1st color in our palette is our background
const background = new THREE.Color(0xf5f5f5)//palette.shift();
canvas.style.background = airSpaceTEX;
...
const airSpaceMat = new THREE.MeshBasicMaterial( { 
  map: airSpaceTEX,
  color: 0xffffff
} )
const bldMat = new THREE.MeshBasicMaterial( { 
  map: bldTEX,
  color: 0xffffff
} )
        ...
        const city = gltf.scene;
            city.traverse( ( child ) => {
                if ( child instanceof THREE.Mesh ) {
                     ...
                     if(child.name.includes("airSpace"))
                    {
                      child.material = airSpaceMat;
                    }
                    else if (child.name.includes("lots"))
                    {
                      child.material = lotMat;
                    }
                    else if (child.name.includes("buildings1"))
                    {
                      child.material = bldMat;
                    }
                    else if (child.name.includes("roads"))
                    {
                      child.material = restMat;
                    }
                    else if (child.name.includes("mountain1"))
                    {
                      child.material = mountainMat;
                    }
                }
            });
