...
var group01Tex = new THREE.TextureLoader().load( "lib/textures/airSpace_bakeGroup_01Shape.png" );
var group02Tex = new THREE.TextureLoader().load( "lib/textures/rest_bakeGroup_02Shape.png" );
var group03Tex = new THREE.TextureLoader().load( "lib/textures/trees_backGroup_03Shape.png" );
...
const gltfLoader = new THREE.GLTFLoader();
        ...
        gltfLoader.load('/models/airSpace_22.glb', (gltf) => {
